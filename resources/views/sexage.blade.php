            ...
            <div class="col-lg-12">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        @endif
                            <div class="row">
                                <form method="post" action="{{ route('sexage_store', $orderDetail->id) }}">
                                    {{ csrf_field() }}
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Recibido por</label>
                                            <input id="txtRecibido" name="txtRecibido" type="text" class="form-control input-sm" value="{{ $orderDetail->sexage->received_by }}" >
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label>Cédula</label>
                                            <input id="txtCedula" name="txtCedula" type="text" class="form-control input-sm" value="{{ $orderDetail->sexage->identification_number }}" >
                                        </div>
                                    </div>
                                    <div class="col-lg-5">
                                        <div class="form-group">
                            ...
                            <form method="POST" action="{{ route('sexage_save', $orderDetail-> id) }}">
                                {{ csrf_field() }}
